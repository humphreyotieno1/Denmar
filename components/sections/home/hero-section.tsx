...
import { ChevronLeft, ChevronRight, Plane, MapPin, StarIcon } from "@/components/ui/huge-icons"
        ...
        >
          ...
          <div className="relative z-10 mx-auto flex h-full max-w-7xl flex-col justify-end px-4 pb-20 pt-[50px] sm:pb-12 sm:justify-center sm:px-6 lg:flex-row lg:items-center lg:gap-12 lg:px-8">
            <div className="w-full text-white lg:w-3/5">
              ...
              <h1 className="mt-6 font-heading text-[32px] font-semibold leading-tight sm:text-4xl md:text-5xl lg:text-6xl lg:leading-[1.08]">
                {slide.title} {slide.highlight && <span className="text-brand-accent">{slide.highlight}</span>}
              </h1>
              <p className="mt-4 text-sm text-white/85 sm:text-base md:text-lg lg:max-w-2xl">
                {slide.subtitle}
              </p>
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
                <Button
                  asChild
                  size="lg"
                  className="bg-brand-accent rounded-full text-brand-primary hover:bg-brand-accent/90 shadow-xl shadow-brand-accent/30"
                >
            ...
            <aside className="hidden w-full max-w-md rounded-3xl bg-white/15 p-[1px] backdrop-blur-sm lg:mt-0 lg:block lg:w-2/5">
              <div className="rounded-[calc(1.5rem-2px)] bg-white/95 p-6 shadow-2xl shadow-black/20">
                ...
                <div className="mt-6 rounded-2xl border border-dashed border-brand-success/50 bg-brand-success/5 p-4">
                  ...
                  <Button asChild size="sm" className="mt-4 w-full rounded-full bg-brand-success text-white hover:bg-brand-success/90">
