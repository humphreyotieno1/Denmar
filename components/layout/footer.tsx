...
import { Facebook, Instagram, Twitter, Mail, Phone, MapPin, Youtube } from "@/components/ui/huge-icons"
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 gap-8">
          ...
          <div className="space-y-6">
            <Link href="/" className="block">
              <Image 
                ...
                width={150} 
                height={60} 
                className="object-contain w-auto h-auto brightness-0 invert"
              />
            </Link>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              />
              <Button
                className="bg-brand-accent rounded-full hover:bg-brand-accent/40 text-brand-primary w-full"
